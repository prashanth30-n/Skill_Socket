...
router.post('/add', verifyToken, async (req, res) => {
    try {
        ...
        const { revieweeId, rating, title, comment, skillContext } = req.body;
...
router.put('/update/:reviewId', verifyToken, async (req, res) => {
    try {
        ...
        const reviewerId = req.user.userId;
        const { rating, title, comment, skillContext } = req.body;
        ...
        if (skillContext !== undefined) review.skillContext = skillContext;
